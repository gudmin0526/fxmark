# LOG_FILE = logs/2025-09-27-17-38-34.029657/fxmark.log
...
set_out='set output "`if test -z $OUT; then echo util.2.pdf; else echo $OUT; fi`"'
eval set_out
...
set title 'nvme:DWAL:*:2:directio'
set xlabel ''
...
plot '-' using 2:xtic(1) title 'user', '' using 3 title 'sys', '' using 4 title 'idle', '' using 5 title 'iowait'
  ...
  "f2fs" 1.34045 56.1932 12.5279 29.4575
e
  # ['user.util', 'sys.util', 'idle.util', 'iowait.util']
  "f2fs" 1.34045 56.1932 12.5279 29.4575
e
